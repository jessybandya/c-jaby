  ...
  return (
    <Card>
      ...
      <Modal.Header style={{display:'block'}}>
         <div style={{alignItems:'center',justifyContent:'space-between',display:'flex'}}><MDTypography>MEMBER/FAMILY</MDTypography> <ClearIcon fontSize='medium' style={{color:'#88888888',cursor:'pointer'}} onClick={handleClose}/></div>
         <div>
